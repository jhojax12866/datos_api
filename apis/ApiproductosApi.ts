...
export class ApiproductosApiRequestFactory extends BaseAPIRequestFactory {
     ...
     */
    public async apiproductosList(categoria?: string, ordering?: string, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;
        ...
        if (categoria !== undefined) {
            requestContext.setQueryParam("categoria", ObjectSerializer.serialize(categoria, "string", ""));
        }
